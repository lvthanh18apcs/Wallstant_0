...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Account settings  Wallstant/p_Gender Required'), 'Gender Required')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Account settings  Wallstant/select_Male             Female'), 
    'Female', true)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Account settings  Wallstant/input_Required_general_current_pass'), 
    'OQ8zmI9A849JsikZb0xAwA==')

WebUI.click(findTestObject('Object Repository/Page_Account settings  Wallstant/input_Required_general_save_changes'))
