...
WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_title'), 'User new note to check')

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/textarea_60_note_content'), '#4 note user')
...
WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_See all notes'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/button_User new note to checkJust now'))
