...
WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/span_Following_fa fa-star-o'))

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/span_Following_fa fa-star'))
