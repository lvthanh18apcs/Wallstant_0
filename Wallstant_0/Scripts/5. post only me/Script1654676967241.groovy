...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_admin1_post_textbox'), 'Post only me!')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post only me'), 'Post only me!')
