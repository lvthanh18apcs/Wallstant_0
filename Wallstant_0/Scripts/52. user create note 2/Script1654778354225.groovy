...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/a_user 1'), 'user 1')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_See all notes0'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/a_New note'))

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_title'), 'User create note')

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/textarea_60_note_content'), 'Note #2')
...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_User create note'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/button_User create noteJust now'))
