...
WebUI.setText(findTestObject('Object Repository/Page_user1  Wallstant/textarea_user1_post_textbox'), 'User post to edit privacy')
...
WebUI.setText(findTestObject('Object Repository/Page_user1  Wallstant/textarea_User post to edit privacy'), 'User post editted')

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_Save'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user1  Wallstant/p_User post editted'), 'User post editted')
