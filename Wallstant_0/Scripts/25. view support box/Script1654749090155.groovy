...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/p_Support box'), 'Support box')

WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/p_Report a problem'), 'Report a problem')
