...
WebUI.setText(findTestObject('Object Repository/Page_Account settings  Wallstant/textarea_at_edit_bio'), 'user wants to change bio but forgot password')
