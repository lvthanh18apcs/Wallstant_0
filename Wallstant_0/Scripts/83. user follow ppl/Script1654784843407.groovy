...
WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/button_Follow'))

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/button_Following'))
