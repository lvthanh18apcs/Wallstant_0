...
WebUI.setText(findTestObject('Object Repository/Page_Account settings  Wallstant/textarea_at_edit_bio'), 'change bio')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_change bio'), 'change bio')

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_Wallstant'))

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/a_Edit profile'))

WebUI.click(findTestObject('Object Repository/Page_Account settings  Wallstant/div_Education            Work    at        _ebe836'))

WebUI.setText(findTestObject('Object Repository/Page_Account settings  Wallstant/textarea_change bio'), '')
