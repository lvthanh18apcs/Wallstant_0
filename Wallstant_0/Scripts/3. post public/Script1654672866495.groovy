...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_admin1_post_textbox'), 'Post public #1')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post public 1'), 'Post public #1')
