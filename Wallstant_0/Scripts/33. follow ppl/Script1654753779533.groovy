...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/td_user 1 user1'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/button_Follow'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/button_Following'))
