...
WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_title'), 'Note #2')

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/textarea_60_note_content'), 'This is the new note')

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_title'), 'Note')
...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_Note'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/button_NoteJust now'))
