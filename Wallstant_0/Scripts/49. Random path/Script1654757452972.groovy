...
WebUI.click(findTestObject('Object Repository/Page_Welcome  Wallstant/input_Login now_login_username'))

WebUI.click(findTestObject('Object Repository/Page_Welcome  Wallstant/div_Welcome to Wallstant        Meet new fr_ca6db3'))

WebUI.setText(findTestObject('Object Repository/Page_Welcome  Wallstant/input_Login now_login_username'), 'admin123123')
...
WebUI.click(findTestObject('Object Repository/Page_Welcome  Wallstant/div_Welcome to Wallstant        Meet new fr_ca6db3_1'))
