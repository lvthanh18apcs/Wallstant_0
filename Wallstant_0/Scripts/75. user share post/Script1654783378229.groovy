...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_user1_post_textbox'), 'User post to share')
...
WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/span_Cancel_fa fa-share-alt'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user1  Wallstant/p_Post shared on your timeline'), 'Post shared on your timeline.')

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_user 1'))
...
WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/button_Load more'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_user1  Wallstant/p_No more stories'), 'No more stories')

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_Home'))
