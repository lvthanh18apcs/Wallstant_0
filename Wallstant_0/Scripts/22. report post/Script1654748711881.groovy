...
WebUI.setText(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_admin1_post_textbox'), 'Post to report')
...
WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_Report post'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post reported we will review your report soon'), 
