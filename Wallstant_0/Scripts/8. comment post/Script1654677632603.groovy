...
WebUI.setText(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_admin1_post_textbox'), 'Post to comment')
...
WebUI.setText(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_Be the first_1656387721'), 'comment')

WebUI.sendKeys(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_Be the first_1656387721'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Page_admin1  Wallstant/span_'))
