...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_user1_post_textbox'), 'User post random steps')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/button_Title'))

WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/input_100_w_title'), 'User random post')
