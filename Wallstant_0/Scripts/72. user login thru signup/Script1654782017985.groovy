...
WebUI.click(findTestObject('Object Repository/Page_Create new account  Wallstant/a_English'))
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Login  Wallstant/input_Login now_login_username'))
