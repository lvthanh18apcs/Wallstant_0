...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_user1_post_textbox'), 'User post to like')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/p_User post to like'), 'User post to like')
