...
WebUI.setText(findTestObject('Object Repository/Page_Welcome  Wallstant/input_Login now_login_username'), '123')

WebUI.click(findTestObject('Object Repository/Page_Welcome  Wallstant/div_Welcome to Wallstant        Meet new fr_ca6db3'))
...
WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_New note'))

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_title'), 'Note from own page')

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/textarea_60_note_content'), 'New note')
...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_See all notes1'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/button_Note from own pageJust now'))
