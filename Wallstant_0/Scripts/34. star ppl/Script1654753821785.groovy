...
WebUI.click(findTestObject('Page_Home  Wallstant/td_user 1 user1 (1)'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/span_Follow_fa fa-star-o'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/span_Follow_fa fa-star'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_Wallstant'))
