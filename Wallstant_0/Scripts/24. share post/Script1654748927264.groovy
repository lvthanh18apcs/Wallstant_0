...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_admin1_post_textbox'), 'Post to be shared!')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post to be shared'), 'Post to be shared!')

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/span_Cancel_fa fa-share-alt'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post shared on your timeline'), 'Post shared on your timeline.')

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_Wallstant'))

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/a_admin 1'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Shared a post'), 'Shared a post')
