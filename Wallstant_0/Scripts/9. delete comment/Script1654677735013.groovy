...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_admin1_post_textbox'), 'Post for delete comment.')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post for delete comment'), 'Post for delete comment.')

WebUI.setText(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_Be the first_1656034446'), 'Here is the comment.')

WebUI.sendKeys(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_Be the first_1656034446'), Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/span_Here is the comment'), 'Here is the comment.')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_Be the first_1656034446'), '')
