...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_user1_post_textbox'), 'User post that has title')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/button_Title'))

WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/input_100_w_title'), 'Title for user post')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/input_Title_post_now'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/p_Title for user post'), 'Title for user post')
...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/a_Home'))

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_user1'))
