...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_admin1_post_textbox'), 'Post to like!')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Post to like'), 'Post to like!')

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/span_Cancel_fa fa-heart-o'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/span_1'), '1')

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/span_Cancel_fa fa-heart_1'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/span_Be the first'), 'Be the first')
