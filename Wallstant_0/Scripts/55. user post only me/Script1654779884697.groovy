...
WebUI.setText(findTestObject('Object Repository/Page_Home  Wallstant/textarea_user1_post_textbox'), 'User post only me, not here tho')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/a_user 1'))

WebUI.setText(findTestObject('Object Repository/Page_user1  Wallstant/textarea_user1_post_textbox'), 'User post only me')
