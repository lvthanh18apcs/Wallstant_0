...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_See all'))

WebUI.click(findTestObject('Object Repository/Page_Notifications  Wallstant/button_Load more'))

WebUI.click(findTestObject('Object Repository/Page_Notifications  Wallstant/a_Home'))
