...
WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/td_admin 1 admin1'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_admin1'), '@admin1')

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_0 Posts'))

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_0 Stars'))

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_3 Followers'))

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/a_3 Following'))
...
WebUI.click(findTestObject('Object Repository/Page_Account settings  Wallstant/p_Remove account'))

WebUI.click(findTestObject('Object Repository/Page_Account settings  Wallstant/a_Home'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/p_user1'), '@user1')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_See all notes'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_New note'))

WebUI.click(findTestObject('Object Repository/Page_Create new note  Wallstant/a_Home'))
