...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Login  Wallstant/h4_Login now'), 'Login now')
...
WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_0 Posts'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_0 Stars'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_1 Followers'))

WebUI.click(findTestObject('Object Repository/Page_user1  Wallstant/a_1 Following'))
