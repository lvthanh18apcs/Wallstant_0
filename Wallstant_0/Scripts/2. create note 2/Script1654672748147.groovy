...
WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/textarea_60_note_content'), 'No delete')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_Home  Wallstant/p_Note 2'), 'Note #2')

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/p_Note 2'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/button_Note 2Just now'))
