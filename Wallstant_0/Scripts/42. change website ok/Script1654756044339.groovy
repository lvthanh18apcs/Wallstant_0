...
WebUI.setText(findTestObject('Object Repository/Page_Account settings  Wallstant/input_at_edit_website'), 'site.com')
...
WebUI.setText(findTestObject('Object Repository/Page_Account settings  Wallstant/input_at_edit_website'), '')
