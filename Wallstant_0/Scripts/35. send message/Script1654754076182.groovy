...
WebUI.click(findTestObject('Object Repository/Page_Messages  Wallstant/p_user 1user1'))

WebUI.setText(findTestObject('Object Repository/Page_Messages  Wallstant/textarea_seen_mSendField'), 'hello from admin')
