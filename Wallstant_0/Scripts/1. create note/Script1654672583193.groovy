...
WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_title'), 'Note #1')

WebUI.setText(findTestObject('Object Repository/Page_Create new note  Wallstant/textarea_60_note_content'), 'Test note')

WebUI.click(findTestObject('Object Repository/Page_Create new note  Wallstant/input_60_note_submit'))

WebUI.click(findTestObject('Object Repository/Page_My notepad  Wallstant/button_Note 1Just now'))
