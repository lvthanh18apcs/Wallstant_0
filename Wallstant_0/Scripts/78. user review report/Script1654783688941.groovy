...
WebUI.setText(findTestObject('Object Repository/Page_Report a problem  Wallstant/input_Report a problem_report_sub'), 'User make #2 report')
...
WebUI.click(findTestObject('Object Repository/Page_Support box  Wallstant/div_User make 2 report openClick to view yo_77ab94'))
