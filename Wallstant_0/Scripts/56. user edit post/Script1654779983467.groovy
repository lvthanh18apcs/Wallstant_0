...
WebUI.setText(findTestObject('Object Repository/Page_user1  Wallstant/textarea_user1_post_textbox'), 'User post to edit')
...
WebUI.setText(findTestObject('Object Repository/Page_user1  Wallstant/textarea_User post to edit'), 'User post editted')
