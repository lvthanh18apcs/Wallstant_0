...
WebUI.setText(findTestObject('Object Repository/Page_admin1  Wallstant/textarea_admin1_post_textbox'), 'Followers post!')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_admin1  Wallstant/select_Public            Followers         _08a2bc'), 
    'Followers', true)

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/input_Title_post_now'))

WebUI.click(findTestObject('Object Repository/Page_admin1  Wallstant/span_Home_fa fa-home'))

WebUI.click(findTestObject('Object Repository/Page_Home  Wallstant/a_admin 1'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_admin1  Wallstant/p_Followers post'), 'Followers post!')
